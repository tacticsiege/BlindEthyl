...
class PoseEstimator(object):
    def __init__(self):
        # use locally sensitive hashing algorithm
        flann_params = dict(algorthm=6, table_number=5, key_size=12, multi_prob_level=1)
    ...
    def add_target(self, image, rect, data=None):
        """ Adds a new target for tracking. """
        ...
        descriptors = np.array(descriptor, dtype='uint8')
